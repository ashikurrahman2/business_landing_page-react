const Services = () => {
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-b from-white via-blue-50 to-white text-center">
      ...
      <div className="grid gap-8 md:grid-cols-3 max-w-7xl mx-auto px-6">
        {services.map((service, index) => (
          <div
            key={index}
            className={`bg-white rounded-2xl p-8 text-left shadow-md hover:shadow-xl transition duration-300 hover:-translate-y-1 border-4 ${service.borderColor}`}
          >
