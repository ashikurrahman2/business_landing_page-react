const About = () => {
  return (
    ...
    >
      ...
      <p className="max-w-3xl mx-auto text-gray-600 mb-12 px-4 text-base sm:text-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-left">
        ...
        <div className="flex justify-center">
          <img
            ...
            alt="About ITBiz"
            className="rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md md:max-w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
          />
        </div>
        ...
        >
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-md">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-blue-700 mb-3">
              Web Solutions Ltd.
            </h3>
